...
|:---:|:---:|---|---|---|
Por supuesto, aquí tienes solo la descripción traducida en el mismo formato de tabla para que puedas copiar y pegar directo:

````
| [0x41haz](./Room/0x41haz/writeup.md) | Facil | Linux | Desafío simple de ingeniería inversa | ```Reverse Engerniering``` |
| [Agent Sudo](./Room/Agent-Sudo/writeup.md) | Facil | Linux | Encontraste un servidor secreto bajo el mar profundo. Tu tarea es hackearlo y revelar la verdad | CTF ```CVE-2019-14287``` |
| [Alfred](https://github.com/Esther7171/THM-Walkthroughs/blob/main/Room/Alfred/readme.md#alfred) | Facil | Windows | Explotar Jenkins para obtener acceso inicial, luego escalar privilegios explotando tokens de autenticación de Windows | `privileges escalation via token impersonation` |
| [Annie](./Room/Annie/writeup.md) | Medio | Linux | El acceso remoto viene en diferentes formas | AnyDesk 5.5.2 – Remote Code Execution ```CVE-2020-13160``` |
| [Anonforce](./Room/Anonforce/writeup.md) | Facil | Linux | Máquina boot2root para FIT y bsides Guatemala CTF | CTF |
| [Archangel](./Room/Archangel/writeup.md) | Facil | Linux | Boot2root, explotación web, escalamiento de privilegios, LFI | CTF |
| [Basic-Pentesting](./Room/Basic-Pentesting/walkthrough.md) | Facil | Linux | Máquina para practicar hacking de aplicaciones web y escalamiento de privilegios | Beginner Level CTF |
| [Battery](./Room/Battery/writeup.md) | Medio | Linux | CTF diseñado por un amante de CTF para amantes de CTF | ```Re-Registration Attack``` ```XML External Entity``` ```Sudo Abuse```|
| [Biteme](./Room/Biteme/writeup.md) | Medio | Linux | ¡Mantente fuera de mi servidor! | CTF |
| [Blue](./Room/Blue/writeup.md) | Facil | Windows | Conceptos básicos de explotación en Windows – Fácil | ```MS17-010``` EternalBlue SMB Remote Windows Kernel Pool Corruption |
| [Blueprint](./Room/Blueprint/writeup.md) | Facil| Windows | Hackea esta máquina Windows y escala privilegios a Administrador | ```osCommerce 2.3.4.1 - Remote Code Execution``` ----------->re doing deleted. it [Lab](https://tryhackme.com/r/room/blueprint) |
| [Bounty Hacker](./Room/Bounty-Hacker/walkthrough.md) | Facil | Linux | Demuestra que eres el hacker más élite del sistema solar | Beginner Level CTF |
| [Break Out The Cage](./Room/Break-Out-The-Cage/writeup.md) | Facil | Linux | Ayuda a Cage a recuperar su carrera actoral e investiga las acciones sospechosas de su agente | CTF | 
| [Brooklyn-Nine-Nine](./Room/Brooklyn-Nine-Nine/walkthrough.md) | Facil | Linux | Esta sala está dirigida a hackers principiantes, pero cualquiera puede intentarlo. Hay dos maneras principales para conseguir root | Beginner Level CTF |
| [Bugged](./Room/Bugged/writeup.md) | Facil | Linux | John vive en un mundo muy conectado a Internet. Quizás demasiado conectado...|  ```IoT Device hacking``` |
| [C4ptur3-th3-fl4g](./Room/C4ptur3-th3-fl4g/writeup.md) | Facil | Linux | Un desafío CTF a nivel principiante | Decodificación de mensajes ```Spectrograms``` ```Esteganografía``` ```Seguridad por oscuridad``` |
| [CMesS](./Room/CMesS) | Medio | Linux | ¿Puedes rootear esta máquina Gila CMS? | ```Gila CMS 1.10.9``` |
| [CTF collection Vol.2](./Room/CTF-collection-Vol.2/writeup.md) | Medio | Linux | Mejora tus habilidades CTF con esta colección centrada en retos web | CTF ```Cryptography``` |
| [Capture!](./Room/Capture!/writeup.md) | Facil | Web | ¿Puedes saltarte el formulario de login? | Vulnerabilidad en autenticación |
| [Careers in Cyber](./Room/Careers-in-Cyber/info.md) | Info | None | Aprende sobre las diferentes carreras en ciberseguridad | Guía |
| [Cheese CTF](./Room/Cheese-CTF/walkthrough.md) | Facil | Linux | Inspirado en la gran charla sobre quesos de THM | CTF ```LFI``` ```RCE``` ```SUID``` |
| [Chocolate_Factory](./Room/Chocolate_Factory/Walkthrough.md) | Facil | Linux | Sala temática de Charlie y la fábrica de chocolate, ¡revive la fábrica de Willy Wonka! | Beginner Level CTF |
| [Cipher's Secret Message](https://github.com/Esther7171/THM-Walkthroughs/blob/main/Room/Cipher's%20Secret%20Message/readme.md#ciphers-secret-message--tryhackme-writeup) | Facil | Any | Mejora tus habilidades criptográficas analizando código para obtener la bandera | `Descifrado César` `Desafío criptográfico` |
| [Cicada-3301 Vol:1](./Room/Cicada-3301-Vol_1/writeup.md) | Medio | Linux | Sala básica de esteganografía y criptografía basada en los retos Cicada 3301 | ```Criptografía``` |
| [Corridor](./Room/Corridor/walkthroug.md) | Facil | Web | ¿Puedes escapar del corredor? | IDOR |
| [Crack the Hash Level 1](./Room/Crack-The-Hash-Level-1/writeup.md) | Facil | Any | Desafíos para descifrar hashes | ```Criptografía```|   
| [Crack The Hash Level 2](./Room/Crack-The-Hash-Level-2/writeup.md) | Medio | Any | Desafíos avanzados para descifrar hashes y generación de listas de palabras | ```Criptografía```|
| [Dogcat](./Room/Dogcat/writeup.md) | Medio | Linux | Sitio para ver fotos de perros y gatos, explota aplicación PHP vía LFI y escapa de un contenedor docker | CTF ```Web``` |
| [Dumping Router Firmware](./Room/Dumping-Router-Firmware/writeup.md) | Medio | Linux | ¿Alguna vez te preguntaste cómo funciona tu router? ¿Qué sistema operativo usa? | Investigación de firmware de routers |
...
| [Tomghost](./Room/Tomghost/writeup.md) | Facil | Linux | Identifica vulnerabilidades recientes para intentar explotar o leer archivos no autorizados | ```CVE-2020–1938``` | 
